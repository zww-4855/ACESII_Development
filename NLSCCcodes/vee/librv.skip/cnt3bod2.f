      SUBROUTINE CNT3BOD2(IRREPX,ICORE,MAXCOR,IUHF,LISTZ0)
C
...
C
        ...
        DO 520 IRREPM=1,NIRREP
         ...
         NCOL=NUMJ
         NSUM=NUMM
         IOFFF=IOFFF0+IINTFP*(ISYMOFF(IRREPJ,IRREPX,20+ISPIN)-1)
         IOFFT=IOFFT0+IINTFP*DISSYT*(ISYMOFF(IRREPM,IRREPTR,8+ISPIN)-1)
         IOFFZ=IOFFZ0+IINTFP*DISSYZ*(ISYMOFF(IRREPJ,IRREPZR,8+ISPIN)-1)
