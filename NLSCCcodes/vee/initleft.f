       SUBROUTINE INITLEFT(ZOUT, NDIM, EOUT, NROOT, Z, HZ, MAXEXP, E0,
...
C
      ...
      print = IFLAGS(1) .GE. 0
C
      IF (PRINT) WRITE(6,*) ' ESTIMATE LEFTHAND '
      IF (PRINT2) THEN
...
C
     ...
     &         ASMALL(1,J), 1)
        ...
        ENDDO
C
C  TRANSPOSE ASMALL TO OBTAIN LEFT EIGENVECTORS
C
        CALL SCOPY(NSPACE*NSPACE, ASMALL, 1, SCR, 1)
        CALL TRANSP(SCR, ASMALL, NSPACE, NSPACE)
C
