      ...
      SUBROUTINE FORM_D2_4RCC(ACORE,OMEGA,LEN_OV,MAXCOR,IUHF,IRREPX,
     +                        LISTD0,IROOT)
C
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      INTEGER DIRPRD,POP,VRT
      LOGICAL SS, SD, DS, DD, REF_ENG_IN_DEN
C
      DIMENSION ACORE(MAXCOR/2)
      DIMENSION IOFFOCC(8,2),IOFFVRT(8,2)
      DOUBLE PRECISION OMEGA(LEN_OV) 
C
...
C
        DO 100 IJ=1,NOCCR
        EVALJ=ACORE(IEVALB+IOFFJ+IJ) + FACT*OMEGA(IROOT)
        DO 100 II=1,NOCCL
...
C
          DO 200 IA=1,NVRTL
          IND=IND+1
          DENOM = 1.0D0/(EVALIJB-ACORE(IEVALA+IOFFA+IA)) 
          ACORE(IEND+IND)=DENOM
...
C
         DO 2900 IRREPRR=1,NIRREP
          ...
          DO 2100 IJ=1,NOCCR
           ...
           EVALJ=ACORE(IEVAL+IOFFJ+IJ) +  FACT*OMEGA(IROOT)
           DO 2100 II=1,IEND1
...
C
           DO 2800 IRREPLR=1,NIRREP
            ...
            DO 2200 IB=1,NVRTR
             ...
             DO 2200 IA=1,IEND2
             IND=IND+1
             DENOM = 1.0D0/(EVALIJB-ACORE(IEVAL+IOFFA+IA)) 
             ACORE(IEND+IND)= DENOM
2200        CONTINUE
2800       CONTINUE
2100      CONTINUE
...
C
       ...
       DO 5000 IRREPR=1,NIRREP
        ...
        DO 5100 I=1,NOCCR
         EVALI=ACORE(IEVAL+IOFFI+I) +  FACT*OMEGA(IROOT)
         DO 5200 IA=1,NVRTL
