      ...
      SUBROUTINE RCL_DWMBEJ_R_4EE_CORR(ICORE,MAXCOR,IUHF)
C
...
CEND
     ...
     &            CC2,RCCD,DRCCD
      ...
      DATA ONEM /-1.0/
C
C Do the triplet spin-adpated term (as in the T code, use the 
C AAAA lists.
C
...
C
      ...
      CALL SAXPY(ISIZE,ONEM,ICORE(I020),1,ICORE(I010),1)
      CALL SAXPY(ISIZE,ONEM,ICORE(I010),1,ICORE(I000),1)

      call checksum("List-256: ",icore(i000),isize,S)
CSSS      CALL SSCAL(ISIZE,TWO,ICORE,1)
CSSS      CALL DSCAL(ISIZE,FACT,ICORE,1)
