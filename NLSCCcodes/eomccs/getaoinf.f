...
C
C      CALL GETREC(20,'JOBARC','NUMBASIR',NIRREP,IAOPOP)
C
C When orbitals are dropped, we must read NUMBASI0 not NUMBASIR.
C I have no idea how many EE calculations have been affected by this error.
C Ajith Perera 06/2005.
C
