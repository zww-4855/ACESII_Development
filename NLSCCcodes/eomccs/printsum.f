      SUBROUTINE PRINTSUM(ROOT,FSTR,CORE_SEARCH)
...
10    CONTINUE
      ...
      IF (CORE_SEARCH) CALL MULTIPOLE(Root)
...
1019  FORMAT(T3,'Total CCD electronic energy ',F20.12,' a.u.')
1020  FORMAT(T3,'Total rCCD electronic energy ',F20.12,' a.u.')
1021  FORMAT(T3,'Total drCCD electronic energy ',F20.12,' a.u.')
1022  FORMAT(T3,'Total LCCD electronic energy ',F20.12,' a.u.')
1023  FORMAT(T3,'Total LCCSD electronic energy ',F20.12,' a.u.')
1024  FORMAT(T3,'Total CC2 electronic energy ',F20.12,' a.u.')
