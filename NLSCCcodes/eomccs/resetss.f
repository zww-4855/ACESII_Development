      SUBROUTINE RESETSS(ICORE,MAXCOR,IUHF)
C
C THIS ROUTINE UNDOS THE FORMATION OF THE SINGLE-SINGLE BLOCK OF EITHER THE REGULAR
...
C         write(6,*) ' non-hf contributions are added in resetss'
C
...
C
      ...
      IOFFV(2)=I030
C
C  NEGATE ALL THE ONE-PARTICLE TERMS
C
        CALL VMINUS(ICORE(I000),(I040-I000)/IINTFP)
C
...
C
C SUBTRACT THE ONE-PARTICLE PART.  HERE WE ARE WORKING WITH THE
...
C
         ...
         CALL SSCAL(ISIZE,HALF,ICORE(I040),1)
        ELSE
         LISTAA=53+ISPIN
         ISIZE=ISYMSZ(ISYTYP(1,LISTAA),ISYTYP(1,LISTAA))
         I050=I040+ISIZE*IINTFP
