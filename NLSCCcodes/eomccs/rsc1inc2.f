      SUBROUTINE RSC1INC2(ICORE,MAXCOR,IUHF,IRREPX,ISIDE,LISTT2IN,
     &                   LISTT2RS)
C
C This routine calculates the parts of Hbar x C1 -> C2 
C  that normally get calculated as part of Hbar x C2 -> C2.
...
C
      IF (ISIDE .EQ. 2) THEN
        CALL RSL1INL2 (ICORE,MAXCOR,IUHF,IRREPX,
     &     LISTT2RS)
        FACT = ONEM
C
