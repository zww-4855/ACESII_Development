         SUBROUTINE  NLO__SYMMETRIC_JACOBI_NBO
     +
     +                    ( DDROWX,DDCOLX,
     +                      DDROWC,DDCOLC,
     +                      DDVECD,
...
C  To test the problem of the Jacobi transformation in NBO part -- Yifan
...
C------------------------------------------------------------------------
C
         write(*,*) "entered symmetric_Jacobi_NBO"
C
