...
C
C                    a) divide number of columns into blocks of 10.
C                    b) loop over all blocks.
C                            loop over all rows in matrix.
C                                 loop over all 10 columns in block.
...
C
     ...
     +         COL .GT. DDCOL         )  THEN
               ...
               WRITE (1,*) ' mat__print_a_float_5_nozeros '
               WRITE (1,*) ' DDROW,DDCOL,ROW,COL = ',
     +                       DDROW,DDCOL,ROW,COL

               WRITE (*,*) ' Dimensions of matrix A too small: '
               WRITE (*,*) ' mat__print_a_float_5_nozeros '
...
C
 5000    FORMAT  (/)
 6000    FORMAT  (/,1X,10I11)
 7000    FORMAT  ()
 8000    FORMAT  (F11.5)
 9000    FORMAT  (1X,I3,10A11)
C
C
C             ...ready!
C
