         SUBROUTINE  MAT__PRINT_A_FLOAT_12_NOZEROS
     +
     +                    ( UNITID,
     +                      TITLE,
     +                      DDROW,DDCOL,
...
C
C                    a) divide number of columns into blocks of 5.
C                    b) loop over all blocks.
C                            loop over all rows in matrix.
C                                 loop over all 5 columns in block.
...
C
     ...
     +         COL .GT. DDCOL         )  THEN
               ...
               WRITE (1,*) ' mat__print_a_float_12_nozeros '
               WRITE (1,*) ' DDROW,DDCOL,ROW,COL = ',
     +                       DDROW,DDCOL,ROW,COL

               WRITE (*,*) ' Dimensions of matrix A too small: '
               WRITE (*,*) ' mat__print_a_float_12_nozeros '
