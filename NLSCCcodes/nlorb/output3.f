      SUBROUTINE OUTPUT3(MATRIX,ROWLOW,ROWHI,COLLOW,COLHI,ROWDIM,COLDIM,
     $                   NCTL)
C
C.......................................................................
C
...
C     REAL   MATRIX(ROWDIM,COLDIM)
 ...
 3000 FORMAT ('0ZERO MATRIX.')
   ...
   15 CONTINUE
      ...
      WRITE (9,1000) (COLUMN,I,I = BEGIN,LAST)
      DO 1 K = ROWLOW,ROWHI

CCC hughes

CCC      DO 4 I=BEGIN,LAST

CCC      IF (MATRIX(K,I).NE.ZERO) GO TO 5
...
CCC hughes
    ...
    5 WRITE (9,2000) CTL,K,(MATRIX(K,I), I = BEGIN,LAST)
    1 CONTINUE
