         SUBROUTINE  MAT__PRINT_A_INTEGER_NOZEROS
     +
     +                    ( UNITID,
     +                      TITLE,
     +                      DDROW,DDCOL,
     ...
     +
C-----------------------------------------------------------------------
C  OPERATION   : MAT__PRINT_A_INTEGER_NOZEROS
C  MODULE      : MATRIX
C  MODULE-ID   : MAT
C  DESCRIPTION : This operation prints a two-dimensional matrix A to
C                the unit specified by UNITID in integer format I8.
C                Only values below 1E+8 can be printed.
C
...
C
C                    a) divide number of columns into blocks of 15.
C                    b) loop over all blocks.
C                            loop over all rows in matrix.
C                                 loop over all 15 columns in block.
...
C
     ...
     +         COL .GT. DDCOL         )  THEN
               ...
               WRITE (1,*) ' mat__print_a_integer_nozeros '
               WRITE (1,*) ' DDROW,DDCOL,ROW,COL = ',
     +                       DDROW,DDCOL,ROW,COL

               WRITE (*,*) ' Dimensions of matrix A too small: '
               WRITE (*,*) ' mat__print_a_integer_nozeros '
